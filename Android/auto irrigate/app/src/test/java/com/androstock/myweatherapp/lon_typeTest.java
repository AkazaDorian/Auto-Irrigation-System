...
public class lon_typeTest {
    @Test
    public void lon_TyprisCorrect() throws Exception {
        ...
        URL url = new URL(String.format(OPEN_WEATHER_MAP_URL, lati, longitude));         //wrong input


        assertEquals("The type of longitude input is not right", right_url,url);
    }
}