...
public class Function {
    ...
    private static final String OPEN_WEATHER_MAP_API = "c2ef5213723585077656f6d12571d5c9";      // This requests the weather information from Openweather  with the personal API
    ...
    public static String setWeatherIcon(int actualId, long sunrise, long sunset){
        ...
        if(actualId == 800){
            ...
            switch(id) {
                case 2 : icon = "&#xf01e;";                                                         // Outputs the correct icon based on the current time
                    break;
                case 3 : icon = "&#xf01c;";
                    break;
                case 7 : icon = "&#xf014;";
        ...
        protected void onPostExecute(JSONObject json) {
            try {
                if(json != null){
                    ...
                    //Outputting the correct data of the weather data
